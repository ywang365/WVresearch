...
* Content
* 1. Data preparation
* 2. Programs for plotting figures of vaccination trends & unadjusted vaccination proportions
...
use "$dir\WVdata_placeboTreatedStates", clear   //The dataset was generated using similar code as for generating WVdata_refine.dta.
